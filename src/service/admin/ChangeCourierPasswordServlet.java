 ...
 * @author RaySong
 */
public class ChangeCourierPasswordServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChangeCourierPasswordServlet() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = CourierCtrl.changeCourierPassword(inputJson);
		}catch(Exception e){
			e.printStackTrace();
