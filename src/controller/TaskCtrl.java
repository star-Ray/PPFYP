	...
	public static JSONObject createTask(JSONObject inputJson){
		...
		try{
			...
			if(sender != null && courier != null && sender != null){
				...
				String startLocation = (String) inputJson.get(Key.STARTLOCATION);
				String endLocation = (String) inputJson.get(Key.ENDLOCATION);
				int random = (int)(Math.random()*9000)+1000;
				String pin = String.valueOf(random);
				
				String taskStatus = "feed in a status for different situation";
				
				Task task = new Task(officer, courier, sender, receiverName, receiverContact, planStartTime,
									planEndTime, actualStartTime, actualEndTime, startLocation, endLocation,
									taskStatus, pin);
				...
				}else if(officer != null && sender != null && courier == null){
					taskStatus = Value.APPROVE;
				}else{
